...
{{< lead >}}
This page brings together the posts that belong to a series, so they can be found and followed in one place rather than scattered through the general list.
{{< /lead >}}

Right now that is the [CompTIA Network+ series]({{< ref "series/comptia-network+" >}}), going through the exam objectives in order, start to finish.
