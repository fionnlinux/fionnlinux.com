...
## {{< icon "graduation-cap" >}} Certifications and Study
...
This page reflects what I actually use today. If something has genuinely helped you on a similar path, I'd like to know about it.

{{< button href="mailto:contact@mail.fionnlinux.com" >}}
